# Privacy Policy — WhiskFul Recipe App
...
WhiskFul is a **self-hosted** recipe management application. Unlike the WickedYoda website (https://www.wickedyoda.com), WhiskFul does not collect, transmit, or share your personal data with any third party. All data you enter stays exclusively on the server you choose to run the application on.

This policy applies specifically to the WhiskFul recipe application and its data handling practices. For the WickedYoda website privacy policy, terms of use, disclaimer, and limitation of liability, please see: [https://www.wickedyoda.com/privacy-policy-terms-of-use-disclaimer-and-limitation-of-liability/](https://www.wickedyoda.com/privacy-policy-terms-of-use-disclaimer-and-limitation-of-liability/)
...
### Self-Hosted Model
WhiskFul is designed to be hosted by you, on a server you control. We (the WickedYoda organization) do **not** collect any data from users of self-hosted instances. This includes:
...
When you use a self-hosted WhiskFul instance, the following may be logged by your server infrastructure:
...
WhiskFul uses **localStorage** (not cookies) to store your JWT authentication token. This token:
...
WhiskFul does **not** integrate with any third-party services. When you self-host:
...
When you self-host WhiskFul, you are responsible for:
...
WickedYoda may update this policy. Changes will be posted here with an updated "Last Updated" date. Material changes will be noted in the WhiskFul release notes on GitHub.
...
This WhiskFul privacy policy supplements the WickedYoda website privacy policy at [wickedyoda.com/privacy-policy](https://www.wickedyoda.com/privacy-policy-terms-of-use-disclaimer-and-limitation-of-liability/). The website policy governs access to the wickedyoda.com website, documentation, and blog content. This policy governs data handling when you install and operate the WhiskFul recipe application on your own server.
