...
GUEST_EMAIL = 'guest@cookierue.app'
GUEST_PASSWORD = 'guest123!'  # Must match frontend loginAsGuest()
...
DEMO_RECIPES = [
    ...
    ('Greek Yogurt Bowl', 'Breakfast',
     ...
     5, 0, 1, 'Easy', ['Breakfast', 'Vegetarian', 'Gluten-Free']),
    ('Avocado Toast', 'Lunch',
    ...
    ('Caprese Salad', 'Appetizers',
     ...
     10, 0, 4, 'Easy', ['Appetizers', 'Italian', 'Vegetarian']),
    ('Chicken Salad', 'Lunch',
    ...
    ('Spaghetti Bolognese', 'Entrees',
     ...
     15, 45, 6, 'Medium', ['Entrees', 'Italian', 'Comfort Food']),
    ('Beef Stir Fry', 'Entrees',
     ...
     15, 10, 4, 'Medium', ['Entrees', 'Quick', 'Comfort Food']),
    ('Chicken Alfredo', 'Entrees',
     ...
     15, 20, 4, 'Medium', ['Entrees', 'Italian', 'Comfort Food']),
    ('Vegetable Curry', 'Entrees',
     ...
     10, 25, 4, 'Medium', ['Entrees', 'Vegetarian', 'Vegan', 'Gluten-Free']),
    ('Tacos', 'Entrees',
     ...
     10, 15, 4, 'Easy', ['Entrees', 'Mexican', 'Comfort Food']),
    ('Salmon with Vegetables', 'Entrees',
     ...
     10, 20, 2, 'Medium', ['Entrees', 'Gluten-Free']),
    ('Ramen', 'Entrees',
     ...
     5, 10, 2, 'Easy', ['Entrees', 'Comfort Food', 'Quick']),
    ('Lasagna', 'Entrees',
     ...
     20, 45, 8, 'Hard', ['Entrees', 'Italian', 'Comfort Food']),
    ...
    ('Deviled Eggs', 'Appetizers',
     ...
     10, 0, 6, 'Easy', ['Appetizers', 'Vegetarian', 'Gluten-Free']),
    ('Bruschetta', 'Appetizers',
     ...
     10, 5, 6, 'Easy', ['Appetizers', 'Italian', 'Vegetarian']),
    ('Guacamole', 'Appetizers',
     'Fresh avocado dip with lime and cilantro.',
     '- 2 ripe avocados\n- 1 lime, juiced\n- 1/4 cup cilantro, chopped\n- 1/4 cup onion, diced\n- 1 jalapeno, seeded and minced\n- Salt to taste\n\n1. Mash avocados.\n2. Add lime juice.\n3. Stir in remaining ingredients.',
     10, 0, 4, 'Easy', ['Appetizers', 'Mexican', 'Vegetarian', 'Gluten-Free']),
    ('Hummus', 'Appetizers',
     ...
     5, 0, 4, 'Easy', ['Appetizers', 'Vegetarian', 'Vegan', 'Gluten-Free']),
    ...
    ('Chicken Noodle Soup', 'Soups',
     ...
     15, 30, 6, 'Medium', ['Soups', 'Comfort Food']),
    ('Minestrone', 'Soups',
     ...
     10, 25, 6, 'Medium', ['Soups', 'Vegetarian', 'Italian']),
    ('Butternut Squash Soup', 'Soups',
     ...
     15, 35, 6, 'Medium', ['Soups', 'Vegetarian', 'Gluten-Free']),

    # Quick & Easy
    ('Pasta Aglio e Olio', 'Entrees',
     ...
     5, 10, 4, 'Easy', ['Entrees', 'Italian', 'Vegetarian', 'Quick']),
    ('One-Pot Rice', 'Entrees',
     ...
     5, 20, 4, 'Easy', ['Entrees', 'Comfort Food', 'Quick']),
    ('Quesadilla', 'Entrees',
     ...
     5, 10, 2, 'Easy', ['Entrees', 'Mexican', 'Quick']),
    ('Rice Bowl', 'Entrees',
     'Bowl with rice, veggies, and protein.',
     '- 1 cup rice\n- 1/2 cup edamame\n- 1/4 cup cucumber, sliced\n- 1/4 avocado\n- 1 tbsp soy sauce\n- 1 tsp sesame oil\n\n1. Cook rice.\n2. Arrange all ingredients in bowl.\n3. Drizzle with soy and sesame oil.',
     10, 10, 2, 'Easy', ['Entrees', 'Vegetarian', 'Gluten-Free', 'Quick']),
    ('Pasta Pomodoro', 'Entrees',
     ...
     5, 15, 4, 'Easy', ['Entrees', 'Italian', 'Vegetarian', 'Gluten-Free']),
]
...
def main():
    ...
    try:
        ...
        # Remove existing demo recipes (but keep user)
        db.query(Recipe).filter(Recipe.user_id == user_id).delete()
        db.query(Tag).filter(Tag.user_id == user_id).delete()
        db.query(GroceryList).filter(GroceryList.user_id == user_id).delete()
        ...
        all_tags = [
            ...
            'Entrees', 'Soups', 'Snack', 'Hard', 'Medium'
        ]
        ...
        # --- Recipes ---
        recipe_ids = []
        for title, category, desc, ingredients, prep, cook, serv, diff, tags in DEMO_RECIPES:
            r = create_recipe(
                db, user_id, title, category, desc,
                ingredients, '',  # ingredients + instructions in one, no separate instructions
        ...
        create_meal_plan(db, user_id, 'This Week', date.today(), [
            ('breakfast', recipe_ids[0]),  # Pancakes
            ('lunch', recipe_ids[7]),       # Avocado Toast
            ('dinner', recipe_ids[11]),     # Chicken Alfredo
            ('dessert', recipe_ids[19]),    # Chocolate Chip Cookies
        ])
